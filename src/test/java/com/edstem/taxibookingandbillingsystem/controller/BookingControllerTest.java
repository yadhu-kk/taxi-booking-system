...
public class BookingControllerTest {
    ...
    void testBookTaxi() throws Exception {
        BookingResponse buildResult = BookingResponse.builder()
                ...
                .userId(1L)
                .build();
        when(bookingService.bookTaxi(Mockito.<BookingRequest>any(), Mockito.<Long>any(), Mockito.<Long>any(),
                Mockito.<Long>any())).thenReturn(buildResult);

        MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/booking/{userId}/{taxiId}", 1L, 1L);
        MockHttpServletRequestBuilder contentTypeResult = postResult.param("distance", String.valueOf(1L))
        ...
        MockMvcBuilders.standaloneSetup(bookingController)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"id\":1,\"userId\":1,\"taxiId\":1,\"pickupLocation\":\"kannur\",\"dropoffLocation\":\"calicut\",\"fare\":15.0,\"bookingTime\":\"2024-02-28 10:18:28.012172\",\"status\":\"CANCELLED\"}"));
    }
    ...
    void testViewBookingDetails() throws Exception {
        ...
        BookingResponse bookingResponse =
                new BookingResponse
                        (1L, 2L, 3L, "kannur", "payyanur", 50.0, "2024-02-29 10:18:28.012172", Status.CONFIRMED);
        ...
        mockMvc.perform(get("/booking/" + id))
                ...
                .andExpect(
                        content()
                                .json(
                                        new ObjectMapper()
                                                .writeValueAsString(bookingResponse)));
    }
